...
const TextLabel: React.FC<React.LabelHTMLAttributes<HTMLLabelElement>> = ({ children, ...props }) => {
...
const TextError: React.FC<React.HTMLAttributes<HTMLParagraphElement>> = ({ children, ...props }) => {
  return (
