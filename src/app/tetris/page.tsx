...
export default function Tetris() {
  ...
  const renderBoard = () => {
    ...
    const boardWithPiece = currentPiece ? mergePieceToBoard(currentPiece, board) : board
      ...
      return Array(3)
        ...
        .map((_, index) => {
          ...
          return (
            <div
              key={index}
              className="mb-2 sm:mb-3 md:mb-4 border-2 border-gray-300 p-1 sm:p-2 bg-gray-900"
            >
  ...
  return (
    <div className={`flex flex-col h-screen items-center justify-center ${purpleDogGradient}`}>
      <div className="flex flex-col md:flex-row items-start p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12">
        ...
        <div className="bg-gray-700 p-3 sm:p-4 md:p-5 lg:p-6 rounded-lg">{renderNextPieces()}</div>
      </div>
